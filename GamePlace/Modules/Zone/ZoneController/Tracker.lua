		...
		local function playerAdded(player)
			local function charAdded(character)
				...
				if humanoid then
					...
					self:update()
					for _, valueInstance in (humanoid:GetChildren()) do
...
function Tracker:update()
	...
	for character, _ in self.characters do
	...
	for additionalPart, _ in self.baseParts do
